...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 5b46f93

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 5aa3977
* **deps:** update dependency tflint to v0.64.0 3da91a0
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template badf6bf
* **v9:** 🐛 synchronize common files and docs ebdafbd

## 8.1.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug b2b0b03

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 9a9b90f
* **deps:** update dependency opentofu to v1.12.2 231d2e4
* **deps:** update dependency opentofu to v1.12.3 800b415
* **deps:** update dependency opentofu to v1.12.4 dbfac9d
* **deps:** update dependency tflint to v0.63.1 86dbfa7
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 cfacc2c
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 90c12b2

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 881168f

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 3001438
* **deps:** update dependency opentofu to v1.12.0 9daaa66
* **deps:** update dependency terraform-docs to v0.23.0 ddd4f7a
* **deps:** update dependency terraform-docs to v0.24.0 5f511ef
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 3e350c6
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 e86876e
* **deps:** update tools 088e42f
* **pre-commit:** 🔧 move to prek 5ae9484
* **tfdocs:** bump tfdocs to v0.22 🔧 9120b40

## 8.1.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ d9f987a

### Code Refactoring

* update module structure and Github actions 👷 c014b06

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing bf0e2c1
* **deps:** 🔗 bump tflint rules version 43f2da8
* **deps:** update dependency trivy to v0.69.2 087d0b8
* **deps:** update dependency trivy to v0.69.3 8b65439
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 1a574e3

## 8.1.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 1f88fe7

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 2903fb6
* **deps:** update dependency opentofu to v1.11.1 12c197d
* **deps:** update dependency opentofu to v1.11.2 51de160
* **deps:** update dependency opentofu to v1.11.3 2569dae
* **deps:** update dependency opentofu to v1.11.4 9d8e860
* **deps:** update dependency opentofu to v1.11.5 1c509e8
* **deps:** update dependency pre-commit to v4.4.0 5037137
* **deps:** update dependency pre-commit to v4.5.0 4d671ca
* **deps:** update dependency pre-commit to v4.5.1 a283446
* **deps:** update dependency terraform-docs to v0.21.0 a1dc36b
* **deps:** update dependency tflint to v0.60.0 05ab059
* **deps:** update dependency tflint to v0.61.0 c6bafe5
* **deps:** update dependency trivy to v0.67.1 e37da53
* **deps:** update dependency trivy to v0.67.2 a71f51c
* **deps:** update dependency trivy to v0.68.1 3804294
* **deps:** update dependency trivy to v0.68.2 6ee7e30
* **deps:** update dependency trivy to v0.69.0 d45bec2
* **deps:** update dependency trivy to v0.69.1 3122fef
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 2beba8f
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 be53308
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 7f987ba
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 8ce4c41
